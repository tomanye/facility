...
namespace PharmInventory.ViewModels
{
    ...
    class AMCViewModel
    {
        ...
        private static void AddorUpdateAmc(int itemId, int storeId,int unitid, int amcRange, DateTime endDate, AmcReportRepository amcrepo, AMCViewModel viewModel, AmcReport allItemIds, DateTime startDate)
        {
            if (allItemIds != null)
            {
                allItemIds.IssueInAmcRange = Builder.CalculateTotalConsumptionWithoutDOS(itemId, storeId, startDate,
                                                                                         endDate);
                ...
                var amcreport = new AmcReport
                                    {
                                        ...
                                        StoreID = storeId,
                                        AmcRange = amcRange,
                                        IssueInAmcRange =Builder.CalculateTotalConsumptionWithoutDOS(itemId, storeId, startDate,
                                                                                        endDate),
                                        ...
                                        AmcWithOutDOS =Builder.CalculateTotalConsumptionWithoutDOS(itemId, storeId, startDate,
                                                                                        endDate)/Convert.ToDouble(viewModel.AmcRange),
                                        UnitID = unitid,
                                    };
