...
namespace DAL
{
	public abstract class _Pallete : SqlClientEntity
	{
		public _Pallete()
		{
			this.QuerySource = "Pallete";
			this.MappingName = "Pallete";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PalleteLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PalleteLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter PalletNo
			{
				get
				{
					return new SqlParameter("@PalletNo", SqlDbType.VarChar, 50);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Pallete.PropertyNames.ID;
					ht[PalletNo] = _Pallete.PropertyNames.PalletNo;
					ht[StorageTypeID] = _Pallete.PropertyNames.StorageTypeID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Pallete.ColumnNames.ID;
					ht[PalletNo] = _Pallete.ColumnNames.PalletNo;
					ht[StorageTypeID] = _Pallete.ColumnNames.StorageTypeID;
		...
		public virtual string PalletNo
	    {
			get
	        {
				return base.Getstring(ColumnNames.PalletNo);
			}
			set
	        {
				base.Setstring(ColumnNames.PalletNo, value);
			}
		}
		...
		public virtual string s_PalletNo
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.PalletNo) ? string.Empty : base.GetstringAsString(ColumnNames.PalletNo);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.PalletNo = base.SetstringAsString(ColumnNames.PalletNo, value);
			}
		}
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PalleteInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PalleteUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PalleteDelete]";
