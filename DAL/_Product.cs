		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Product.PropertyNames.ID;
					ht[IIN] = _Product.PropertyNames.IIN;
					ht[ATC] = _Product.PropertyNames.ATC;
					ht[Description] = _Product.PropertyNames.Description;
					ht[TypeID] = _Product.PropertyNames.TypeID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Product.ColumnNames.ID;
					ht[IIN] = _Product.ColumnNames.IIN;
					ht[ATC] = _Product.ColumnNames.ATC;
					ht[Description] = _Product.ColumnNames.Description;
					ht[TypeID] = _Product.ColumnNames.TypeID;
