		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _Disposal.PropertyNames.ID;
					ht[ItemID] = _Disposal.PropertyNames.ItemID;
					ht[StoreId] = _Disposal.PropertyNames.StoreId;
					ht[ReasonId] = _Disposal.PropertyNames.ReasonId;
					ht[Quantity] = _Disposal.PropertyNames.Quantity;
					ht[Date] = _Disposal.PropertyNames.Date;
					ht[ApprovedBy] = _Disposal.PropertyNames.ApprovedBy;
					ht[Losses] = _Disposal.PropertyNames.Losses;
					ht[BatchNo] = _Disposal.PropertyNames.BatchNo;
					ht[Remark] = _Disposal.PropertyNames.Remark;
					ht[Cost] = _Disposal.PropertyNames.Cost;
					ht[RefNo] = _Disposal.PropertyNames.RefNo;
					ht[EurDate] = _Disposal.PropertyNames.EurDate;
					ht[RecID] = _Disposal.PropertyNames.RecID;
