...
namespace DAL
{
	public abstract class _SupplyCategory : SqlClientEntity
	{
		public _SupplyCategory()
		{
			this.QuerySource = "SupplyCategory";
			this.MappingName = "SupplyCategory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SupplyCategoryLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_SupplyCategoryLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _SupplyCategory.PropertyNames.ID;
					ht[Name] = _SupplyCategory.PropertyNames.Name;
					ht[ParentId] = _SupplyCategory.PropertyNames.ParentId;
					ht[Code] = _SupplyCategory.PropertyNames.Code;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _SupplyCategory.ColumnNames.ID;
					ht[Name] = _SupplyCategory.ColumnNames.Name;
					ht[ParentId] = _SupplyCategory.ColumnNames.ParentId;
					ht[Code] = _SupplyCategory.ColumnNames.Code;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SupplyCategoryInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SupplyCategoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_SupplyCategoryDelete]";
