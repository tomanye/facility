...
namespace DAL
{
	public abstract class _ProductsCategory : SqlClientEntity
	{
		public _ProductsCategory()
		{
			this.QuerySource = "ProductsCategory";
			this.MappingName = "ProductsCategory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ProductsCategoryLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ProductsCategoryLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ProductsCategory.PropertyNames.ID;
					ht[SubCategoryID] = _ProductsCategory.PropertyNames.SubCategoryID;
					ht[ItemId] = _ProductsCategory.PropertyNames.ItemId;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ProductsCategory.ColumnNames.ID;
					ht[SubCategoryID] = _ProductsCategory.ColumnNames.SubCategoryID;
					ht[ItemId] = _ProductsCategory.ColumnNames.ItemId;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ProductsCategoryInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ProductsCategoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ProductsCategoryDelete]";
