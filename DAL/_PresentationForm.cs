...
namespace DAL
{
	public abstract class _PresentationForm : SqlClientEntity
	{
		public _PresentationForm()
		{
			this.QuerySource = "PresentationForm";
			this.MappingName = "PresentationForm";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PresentationFormLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_PresentationFormLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _PresentationForm.PropertyNames.ID;
					ht[Form] = _PresentationForm.PropertyNames.Form;
					ht[Description] = _PresentationForm.PropertyNames.Description;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _PresentationForm.ColumnNames.ID;
					ht[Form] = _PresentationForm.ColumnNames.Form;
					ht[Description] = _PresentationForm.ColumnNames.Description;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PresentationFormInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PresentationFormUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_PresentationFormDelete]";
