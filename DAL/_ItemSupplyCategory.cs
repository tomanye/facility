...
namespace DAL
{
	public abstract class _ItemSupplyCategory : SqlClientEntity
	{
		public _ItemSupplyCategory()
		{
			this.QuerySource = "ItemSupplyCategory";
			this.MappingName = "ItemSupplyCategory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ItemSupplyCategoryLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ItemSupplyCategoryLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ItemSupplyCategory.PropertyNames.ID;
					ht[ItemID] = _ItemSupplyCategory.PropertyNames.ItemID;
					ht[CategoryID] = _ItemSupplyCategory.PropertyNames.CategoryID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ItemSupplyCategory.ColumnNames.ID;
					ht[ItemID] = _ItemSupplyCategory.ColumnNames.ItemID;
					ht[CategoryID] = _ItemSupplyCategory.ColumnNames.CategoryID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemSupplyCategoryInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemSupplyCategoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemSupplyCategoryDelete]";
