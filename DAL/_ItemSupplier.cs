...
namespace DAL
{
	public abstract class _ItemSupplier : SqlClientEntity
	{
		public _ItemSupplier()
		{
			this.QuerySource = "ItemSupplier";
			this.MappingName = "ItemSupplier";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ItemSupplierLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ItemSupplierLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ItemSupplier.PropertyNames.ID;
					ht[SupplierID] = _ItemSupplier.PropertyNames.SupplierID;
					ht[ItemID] = _ItemSupplier.PropertyNames.ItemID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ItemSupplier.ColumnNames.ID;
					ht[SupplierID] = _ItemSupplier.ColumnNames.SupplierID;
					ht[ItemID] = _ItemSupplier.ColumnNames.ItemID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemSupplierInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemSupplierUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ItemSupplierDelete]";
