...
namespace DAL
{
	public abstract class _ReceivePallete : SqlClientEntity
	{
		public _ReceivePallete()
		{
			this.QuerySource = "ReceivePallete";
			this.MappingName = "ReceivePallete";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReceivePalleteLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReceivePalleteLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ReceivePallete.PropertyNames.ID;
					ht[ReceiveID] = _ReceivePallete.PropertyNames.ReceiveID;
					ht[PalletID] = _ReceivePallete.PropertyNames.PalletID;
					ht[ReceivedQuantity] = _ReceivePallete.PropertyNames.ReceivedQuantity;
					ht[Balance] = _ReceivePallete.PropertyNames.Balance;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ID] = _ReceivePallete.ColumnNames.ID;
					ht[ReceiveID] = _ReceivePallete.ColumnNames.ReceiveID;
					ht[PalletID] = _ReceivePallete.ColumnNames.PalletID;
					ht[ReceivedQuantity] = _ReceivePallete.ColumnNames.ReceivedQuantity;
					ht[Balance] = _ReceivePallete.ColumnNames.Balance;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceivePalleteInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceivePalleteUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceivePalleteDelete]";
